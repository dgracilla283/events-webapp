...
if (!function_exists('load_js'))
{
    function load_js(array $files, $version = '')
    {
        ...
        return '<script type="text/javascript" src="' . $base_url . 'loader/js/' . urlencode(implode('|', $files)) . '/' . $version . '"></script>';
    }
}
...
if (!function_exists('load_css'))
{
    function load_css(array $files, $version = '')
    {
        ...
        return '<link type="text/css" rel="stylesheet" href="' . $base_url . 'loader/css/' .urlencode(implode('|', $files)) . '/' . $version . '" />';
    }
}
